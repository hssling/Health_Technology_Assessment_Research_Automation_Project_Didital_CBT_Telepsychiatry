# 💉 Fractional Dose IPV Adult Vaccination Dashboard

[![Streamlit App](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://hta-vaccines-fd-ipv-adult.streamlit.app/)
...
An interactive Streamlit dashboard presenting the cost-effectiveness analysis of cost-effectiveness analysis of fractional dose inactivated poliovirus vaccine for adults.
...
Access the interactive dashboard at: [https://hta-vaccines-fd-ipv-adult.streamlit.app/](https://hta-vaccines-fd-ipv-adult.streamlit.app/)
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/hssling/hta-vaccines-fd-ipv-adult-dashboard.git
   cd hta-vaccines-fd-ipv-adult-dashboard
   ```
...
```bibtex
@software{siddalingaiah_vaccines_hta_2025,
  author       = {Siddalingaiah H S},
  title        = {Fractional Dose IPV Adult Vaccination Dashboard},
  year         = {2025},
  publisher    = {Zenodo},
  doi          = {10.5281/zenodo.123456789},
  url          = {https://hta-vaccines-fd-ipv-adult.streamlit.app/}
}
```
