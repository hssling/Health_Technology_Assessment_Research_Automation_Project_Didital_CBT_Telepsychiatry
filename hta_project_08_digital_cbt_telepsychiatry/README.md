# 🧠 Digital CBT and Telepsychiatry Dashboard

[![Streamlit App](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://hta-digital-cbt-telepsychiatry.streamlit.app/)
...
An interactive Streamlit dashboard presenting the cost-effectiveness analysis of cost-effectiveness analysis of digital cognitive behavioral therapy and telepsychiatry services.
...
Access the interactive dashboard at: [https://hta-digital-cbt-telepsychiatry.streamlit.app/](https://hta-digital-cbt-telepsychiatry.streamlit.app/)
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/hssling/hta-digital-cbt-telepsychiatry-dashboard.git
   cd hta-digital-cbt-telepsychiatry-dashboard
   ```
...
```bibtex
@software{siddalingaiah_digital_hta_2025,
  author       = {Siddalingaiah H S},
  title        = {Digital CBT and Telepsychiatry Dashboard},
  year         = {2025},
  publisher    = {Zenodo},
  doi          = {10.5281/zenodo.123456789},
  url          = {https://hta-digital-cbt-telepsychiatry.streamlit.app/}
}
```
