...
# Page configuration
st.set_page_config(
    page_title="Digital CBT and Telepsychiatry",
    page_icon="🧠",
    layout="wide",
...
def create_visualization(results):
    ...
    fig.update_layout(
        title='Digital CBT and Telepsychiatry',
        xaxis_title='X Axis',
        yaxis_title='Y Axis',
        showlegend=True,
        height=500
...
def main():
    ...
    # Main header
    st.markdown('<h1 class="main-header">🧠 Digital CBT and Telepsychiatry</h1>', unsafe_allow_html=True)
    st.markdown("**Cost-Effectiveness Analysis of Digital Cognitive Behavioral Therapy and Telepsychiatry Services**")
