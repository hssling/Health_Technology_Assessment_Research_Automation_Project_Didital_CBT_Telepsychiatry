# 🤖 AI-Assisted TB Screening Dashboard

[![Streamlit App](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://hta-ai-tb-screening.streamlit.app/)
...
An interactive Streamlit dashboard presenting the cost-effectiveness analysis of cost-effectiveness analysis of artificial intelligence for tuberculosis diagnosis.
...
- **ICER**: 8500 per QALY gained (Cost-Effective)
- **Data Sources**: Peer-reviewed studies from PubMed/MEDLINE
- **Methodology**: Economic evaluation with Markov modeling

## 🚀 Live Demo

Access the interactive dashboard at: [https://hta-ai-tb-screening.streamlit.app/](https://hta-ai-tb-screening.streamlit.app/)
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/hssling/hta-ai-tb-screening-dashboard.git
   cd hta-ai-tb-screening-dashboard
   ```
...
```bibtex
@software{siddalingaiah_ai_hta_2025,
  author       = {Siddalingaiah H S},
  title        = {AI-Assisted TB Screening Dashboard},
  year         = {2025},
  publisher    = {Zenodo},
  doi          = {10.5281/zenodo.123456789},
  url          = {https://hta-ai-tb-screening.streamlit.app/}
}
```
